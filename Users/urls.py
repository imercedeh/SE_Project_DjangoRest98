...
from Users.views import Signup,LeaderCreation,Profile,LeadPlace,LeadersView,LeaderAdvanceSearch,LeaderSortView,UserAdvanceSearch,UsersView,ChangeAvailability,RateLeader,SetLeaderFreeTimes
...
urlpatterns = [
    ...
    url(r'RateLeader/',RateLeader.as_view()),
    url(r'SetFreeTime/',SetLeaderFreeTimes.as_view()),
